...
def submit_analysis_job(workdir: str, pattern: str, outputfile: str, tag: str="", partition: str = "default") -> int:
    ...
    return submit(runcmd, get_cluster(), "analysis_jobtimes", logfile, get_default_partition(get_cluster()) if partition == "default" else partition, 0, "02:00:00", "2G")
...
if __name__ == "__main__":
    ...
    jobid = submit_analysis_job(args.workdir, args.pattern, args.outputfile, args.tag, args.partition)
